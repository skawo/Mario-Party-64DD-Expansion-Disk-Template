...
const unsigned char C1_Length = 7;
...
const unsigned char SECTOR_SIZES[] = {0xE8, 0xD8, 0xD0, 0xC0, 0xB0, 0xA0, 0x90, 0x80, 0x70};
#define SECTOR_SIZE_ZONE0_DEV 0xC0

/* Block Size in bytes [zone] */
const unsigned short BLOCK_SIZES[] = {0x4D08, 0x47B8, 0x4510, 0x3FC0, 0x3A70, 0x3520, 0x2FD0, 0x2A80, 0x2530};
#define BLOCK_SIZE_ZONE0_DEV 0x3FC0

/* LBA to VZone [type][vzone] */
const unsigned short VZONE_LBA_TBL[7][16] = 
{
...
const unsigned short SCYL_ZONE_TBL[2][8] = 
{
...
const unsigned short OUTERCYL_TBL[] = {0x000, 0x09E, 0x13C, 0x1D1, 0x266, 0x2FB, 0x390, 0x425};

/* VZone to PZone [type][vzone] */
const unsigned char VZONE_PZONE_TBL[7][16] = 
{
...
const unsigned short RAM_START_LBA[] = {0x5A2, 0x7C6, 0x9EA, 0xC0E, 0xE32, 0x1010, 0x10DC};

#define LBA_DISK_CHECK 12

int LBAToVZone(int lba, int disktype) 
{
